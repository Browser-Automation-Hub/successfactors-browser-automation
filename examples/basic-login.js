/**
 * basic-login.js — Basic login example for SAP SuccessFactors
...
async function main() {
  ...
  try {
    log('Starting SAP SuccessFactors automation (Open Source mode)');
    ...
    const result = await login_sf(page, {
    ...
    // const data = await run_workforce_report(page, {});
    // log('Data:', data);
